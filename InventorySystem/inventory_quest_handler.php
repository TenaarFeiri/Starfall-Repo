...
if(!isset($arr['npcId']) or empty($arr['npcId']))
{
    die("err:No npcId provided.");
}
if(!isset($arr['func']))
{
...
$quest = new quests($arr['uuid'], $arr['npcId']);
if($arr['func'] == "openBlurb" and isset($arr['blurbData']))
{
    echo $quest->openBlurb($arr['blurbData']);
}
